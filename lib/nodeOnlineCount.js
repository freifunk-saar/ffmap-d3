...
define("nodeOnlineCount", [
  ...
  "config"
	...
	function clients(nodesTarget, fn) {
		function updateNodes(data) {
			var onlineNodeCount = data.nodes.reduce(function(a, d) { return a + d.clientcount }, 0)
			nodesTarget.text(onlineNodeCount)
		}
	...
	clients(d3.select("#clientcount"), ffmapConfig.nodesJSON)
})
