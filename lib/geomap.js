define("geomap", [
  ...
  function init() {
    ...
    map.addLayer(new L.TileLayer("https://a.tile.openstreetmap.org/{z}/{x}/{y}.png", {
      subdomains: "1234",
      type: "osm",
  ...
  function update(data) {
    ...
    if (isFinite(params.lat) && isFinite(params.lon)) {
      ...
      map.setView(L.latLng(params.lat, params.lon), zoom)
		...
		// Set view to center of Saarland (http://de.wikipedia.org/wiki/Falscheid_%28Saarland%29)
		map.setView(new L.LatLng(49.37715, 6.878378), 10)
		//map.fitBounds(bounds)
